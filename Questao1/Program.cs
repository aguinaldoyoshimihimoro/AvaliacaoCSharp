...
namespace Questao1 {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine("Conta " + conta.Numero + ", Titular:" + conta.Titular + ", Saldo: $ " + $" {conta.ConsultaSaldo().ToString("0.00", CultureInfo.GetCultureInfo("en"))}");

            Console.WriteLine();
            Console.Write("Entre um valor para depósito: ");
            double quantia = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);
            object value = conta.Deposito(quantia);
            ...
            object value1 = conta.Saque(quantia);
            Console.WriteLine("Dados da conta atualizados:");
            Console.WriteLine("Conta " + conta.Numero + ", Titular:" + conta.Titular + ", Saldo: $ " + $" {conta.ConsultaSaldo().ToString("0.00", CultureInfo.GetCultureInfo("en"))}");
